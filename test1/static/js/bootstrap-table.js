...
!function ($) {
    ...
    BootstrapTable.prototype.resetHeader = function () {
        ...
        this.timeoutId_ = setTimeout($.proxy(this.fitHeader, this), this.$el.is(':hidden') ? 200 : 0);
    };
    ...
    BootstrapTable.prototype.fitHeader = function () {
        ...
        if (that.$el.is(':hidden')) {
            that.timeoutId_ = setTimeout($.proxy(that.fitHeader, that), 200);
            return;
        }
    ...
    BootstrapTable.prototype.fitFooter = function () {
        ...
        if (this.$el.is(':hidden')) {
            this.timeoutFooter_ = setTimeout($.proxy(this.fitFooter, this), 200);
            return;
        }
